...
- 🎵 **Adaptive Media Hub**: Seamless playback controls, real-time audio progress, and full volume integration for Spotify, Apple Music, YouTube, and web browsers.
...
- 📸 **Privacy-First Mirror**: Fast on-demand camera preview with zero background CPU/RAM overhead when closed.
