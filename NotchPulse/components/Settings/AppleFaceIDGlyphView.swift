//
//  AppleFaceIDGlyphView.swift
//  NotchPulse
//
//  Vector Apple Face ID Glyph with 3D Swivel and Unlock Animation
//
    ...
    var body: some View {
        GeometryReader { geo in
            ...
            Path { path in
                ...
                path.addQuadCurve(to: CGPoint(x: r, y: h), control: CGPoint(x: 0, y: 0))
...
// MARK: - Apple 3D Face ID Swivel & Unlocking Lock Glyph
