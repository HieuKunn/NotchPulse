...
@MainActor
final class NotchPulseLivenessAnalyzer {
    ...
    func observe(_ frame: LivenessFrame) -> LivenessSnapshot {
        ...
        let geometry = NotchPulseGeometryLiveness.evaluate(frames)
        lastGeometry = geometry

        let readings = NotchPulseLivenessCues.readings(window: frames, geometry: geometry)
