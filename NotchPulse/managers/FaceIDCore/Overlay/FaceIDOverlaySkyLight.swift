...
//
//  Toggle delegation ONLY while the screen is actually locked — see FaceIDOverlayWindowController.
//
...
final class FaceIDOverlaySkyLight {
    ...
    /// not a crash.
    static let shared: FaceIDOverlaySkyLight? = FaceIDOverlaySkyLight()
