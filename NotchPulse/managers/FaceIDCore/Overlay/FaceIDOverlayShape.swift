...
//  per side for the flare (see `FaceIDOverlayGeometry.flareAllowance`).
//
...
struct FaceIDOverlayShape: Shape {
    var topRadius: CGFloat
    var bottomRadius: CGFloat
    var style: FaceIDOverlayPanelStyle = .notch
...
#Preview("Notch") {
    FaceIDOverlayShape(topRadius: 16, bottomRadius: 65)
        .frame(width: 380, height: 260)
        .padding(20)
}

#Preview("Notch — closed") {
    FaceIDOverlayShape(topRadius: 8, bottomRadius: 12)
        .frame(width: 200, height: 32)
        .padding(20)
}

#Preview("Pill — collapsed") {
    FaceIDOverlayShape(topRadius: 16, bottomRadius: 16, style: .pill)
        .frame(width: FaceIDOverlayGeometry.pillClosedSize.width, height: FaceIDOverlayGeometry.pillClosedSize.height)
        .padding(20)
}

#Preview("Pill — expanded") {
    FaceIDOverlayShape(
        topRadius: FaceIDOverlayGeometry.pillOpenCornerRadius,
        bottomRadius: FaceIDOverlayGeometry.pillOpenCornerRadius,
        style: .pill
    )
